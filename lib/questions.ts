...
export const QUESTIONS: Question[] = [
  ...
  { id: 2, dimension: "security", prompt: "你感觉对方今天聊天的语气比平时冷淡：", options: options(["觉得可能只是状态不好", "会注意到，但先观察一下", "会开始回想自己是不是说错了什么", "很难不去想是不是关系发生了变化"]) },
  { id: 3, dimension: "security", prompt: "已经约好的见面被对方临时取消：", options: options(["完全能理解，重新约时间即可", "有一点失望，但很快过去", "会有些不安，想知道真正原因", "很容易联想到对方是不是没那么想见我"]) },
  { id: 4, dimension: "security", prompt: "对方以前每天都会说晚安，今天突然没有：", options: options(["完全不会在意", "会注意到，但不会多想", "会觉得有点奇怪", "会明显在意关系是不是哪里出了问题"]) },
  ...
  { id: 8, dimension: "closeness", prompt: "发生一件特别开心的事情时：", options: options(["我通常先自己享受这件事", "之后聊天的时候再告诉对方", "会第一时间想发消息告诉对方", "会马上想视频、打电话甚至见对方"]) },
  ...
  { id: 11, dimension: "expression", prompt: "当你确定自己喜欢一个人：", options: options(["通常会把感情藏起来", "会通过一些小动作暗示", "会主动释放比较明确的信号", "我愿意很直接地告诉对方"]) },
  { id: 12, dimension: "expression", prompt: "当你因为某件事情吃醋：", options: options(["通常不会说出来", "可能会用一点暗示表达", "会告诉对方我为什么不舒服", "会直接把感受和边界讲清楚"]) },
  { id: 13, dimension: "expression", prompt: "当你非常想念对方：", options: options(["想念归想念，不一定会说", "通常会等对方先联系", "会主动告诉对方“我想你了”", "会直接提出见面、通话或者视频"]) },
  { id: 14, dimension: "expression", prompt: "关系中有什么事情让你不舒服：", options: options(["习惯先自己消化", "等情绪过去以后再看有没有必要说", "会找机会把感受告诉对方", "通常会尽快把需求明确说出来"]) },
  { id: 15, dimension: "expression", prompt: "你很喜欢伴侣某个地方时：", options: options(["我心里知道就好", "偶尔会说一句", "经常会主动表达欣赏", "我会很具体、很直接地夸对方"]) },
  ...
  { id: 19, dimension: "conflict", prompt: "发生矛盾以后，对方突然沉默：", options: options(["我不会追问，等对方愿意说", "会先给对方一些空间", "过一会儿会主动问问情况", "我会很想马上知道问题到底是什么"]) },
